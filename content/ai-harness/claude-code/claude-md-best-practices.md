...
`/compact`나 `/clear` 후에도 **CLAUDE.md는 디스크에서 다시 로드되어 컨텍스트에 주입**된다. 매번 반복해야 하는 중요한 규칙은 대화에 적지 말고 CLAUDE.md에 적어두면 압축 후에도 유실되지 않는다. ([Context Management](/ai-harness/claude-code/context-management) 참고)
...
- [Context Management](/ai-harness/claude-code/context-management) — 압축 시 CLAUDE.md가 보존되는 메커니즘
- [Plan Mode](/ai-harness/claude-code/plan-mode) — 복잡한 작업의 방향 잡기
